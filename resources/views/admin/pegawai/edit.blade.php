...
<div class="padding">
    ...
    {!! Form::model($user, ['method' => 'PATCH','route' => ['pegawai.update',$user->id
    ],'files' => true]) !!}
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                ...
                {!! Form::text('alamat', $user->pegawai->alamat, array('placeholder' => 'Alamat','class' => 'form-control')) !!}
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>KTP :</strong>
                {!! Form::text('ktp', $user->pegawai->ktp, array('placeholder' => 'KTP','class' => 'form-control'))
                !!}
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
                <strong>No. HP / Telepon:</strong>
                {!! Form::text('telp', null, array('placeholder' => 'Nomor HP / Telepon','class' => 'form-control')) !!}
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-md-12">
            <div class="form-group">
