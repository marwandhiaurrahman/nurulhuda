        ...
        <div class="col-lg-12">
            <div class="box">
                ...
                <div class="box-body p-v-md">
                    ...
                    @endif
                    {!! Form::open(array('route' => 'arsip.store','method'=>'POST','files' => true)) !!}
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                {!! Form::label('file', 'Pilih File yang akan di Upload :') !!}
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12">
                            <div class="form-group">
                                ...
                                {!! Form::textarea('keterangan', null, array('placeholder' => 'Masukan Keterangan','class'
                                => 'form-control')) !!}
                            </div>
                        </div>
