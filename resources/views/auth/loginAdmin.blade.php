...
<head>
    <meta charset="utf-8" />
    <title>Sign In Admin- Sistem Informasi Yayasan Nurul Huda Kertawangunan</title>
...
<body>
  ...
  background: url('../assets/images/background_gedung_blur.jpg');
  overflow: hidden;
  width: 100%;
  padding: 0px 15px 190px 15px;">

        <!-- ############ LAYOUT START-->
        <div class="container center-block w-xxl w-auto-xs">
            <div class="row">
                <div class="col-xs-6 col-md-4">
                    <div class="center-block w-xxl w-auto-xs p-y-md">
                        ...
                        <div class="p-a-md box-color r box-shadow-z1 text-color shadow-side">
                            ...
                            <div class="p-v-lg text-center" style="margin-top: 15px">
                                <div class="m-b"><a ui-sref="access.forgot-password"
                                        href="{{ url('/password/reset') }}" class="text-primary _600">Lupa
                                        Password/PIN?</a></div>
                            </div>
                        </div>
                    </div>
